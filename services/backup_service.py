    ...
    def _build_backup_archive(self, settings: dict[str, object], *, trigger: str) -> bytes:
        ...
        with tarfile.open(fileobj=buffer, mode="w:gz") as archive:
            ...
            if include.get("image_tasks"):
                ...
                self._add_file_to_archive(archive, DATA_DIR / "image_tasks.db", "data/image_tasks.db")
                self._add_file_to_archive(archive, DATA_DIR / "image_tasks.db-wal", "data/image_tasks.db-wal")
                self._add_file_to_archive(archive, DATA_DIR / "image_tasks.db-shm", "data/image_tasks.db-shm")
